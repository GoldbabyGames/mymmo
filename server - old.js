...
// const { initializeArenaSocket } = require('./socket/arenaSocket');
...
// Add this debug log
console.log('Colyseus Server instance:', {
    isInstance: gameServer instanceof Server,
    methods: Object.getOwnPropertyNames(Object.getPrototypeOf(gameServer)),
    create: typeof gameServer.create,
    define: typeof gameServer.define
});
...
gameServer.define("arena_room", ArenaRoom)
    .enableRealtimeListing() // Enable real-time room listing
...
console.log('Colyseus server methods available:', Object.keys(gameServer));


// Initialize socket handlers
initializeGameSockets(io);
// initializeArenaSocket(io, gameServer);  // Add Arena socket initialization
